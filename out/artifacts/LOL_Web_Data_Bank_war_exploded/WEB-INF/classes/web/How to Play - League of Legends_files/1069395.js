...
tldc.cvPx['1069395'] = {};
tldc.cvPx['1069395'].a = 1069395;
tldc.cvPx['1069395'].l = [];
tldc.cvPx['1069395'].i = 7; 
tldc.cvPx['1069395'].c = 30; 
tldc.cvPx['1069395'].t = 'c';
tldc.cvPx['1069395'].m = 'null';
tldc.cvPx['1069395'].vi = 0;
tldc.cvPx['1069395'].vc = 0;
tldc.cvPx['1069395'].hf = 0;
tldc.cvPx['1069395'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(1069395) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(1069395);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=1069395";
    else asrc="https://secure.adnxs.com/px?id=1069395";
...
if ( tldc.cvPx['1069395'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['1069395'])) ) tldc.cvPx['1069395'].hf = 1;
}
