...
tldc.cvPx['1069394'] = {};
tldc.cvPx['1069394'].a = 1069394;
tldc.cvPx['1069394'].l = [];
tldc.cvPx['1069394'].i = 7; 
tldc.cvPx['1069394'].c = 30; 
tldc.cvPx['1069394'].t = 'h';
tldc.cvPx['1069394'].m = 'null';
tldc.cvPx['1069394'].vi = 0;
tldc.cvPx['1069394'].vc = 0;
tldc.cvPx['1069394'].hf = 0;
tldc.cvPx['1069394'].x = tldc.xtra;
...
var TradeLabConvTracker = function (cdata) {
  ...
  if ( typeof tldc.tl_getAnalyticsData === 'undefined' && typeof tl_getAnalyticsData === 'function' ) tldc.tl_getAnalyticsData = tl_getAnalyticsData;   
    ...
    if ( !tldc.tl_check4xconv(1069394) ) {
        if ( typeof tldc.tl_addXconv === 'function' ) tldc.tl_addXconv(1069394);
      }
      else xval = 0;
  }
  if ( typeof document.cookie != 'undefined' ) {
    ...
    a.style.height = 0;
    a.style.width = 0;    
    if ( document.location.protocol == 'http:' ) asrc="http://ib.adnxs.com/px?id=1069394";
    else asrc="https://secure.adnxs.com/px?id=1069394";
...
if ( tldc.cvPx['1069394'].hf == 0 ) {  
  if ( TradeLabConvTracker(stringify(tldc.cvPx['1069394'])) ) tldc.cvPx['1069394'].hf = 1;
}
